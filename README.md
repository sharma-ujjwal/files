...
<p:dataTable
    ...
    <!-- New column to trigger Ajax and access DataTable -->
    <p:column headerText="Actions">
        <p:commandButton value="View Details" process="@this">
            <p:ajax event="click" listener="#{reviewManagementDashboardBean.onAjaxFromRow}" />
        </p:commandButton>
    </p:column>
